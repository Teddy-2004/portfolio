...
const PROJECTS: Project[] = [
  { title:"World Cup Prediction",        desc:"Deep learning system for stock forecasting using LSTM networks, feature engineering, sentiment analysis, and time-series modeling.",  tech:["Python","FastAPI","scikit-learn","Pandas","XGBoost", "PyTorch", "SciPy", "SQLite", "Docker", "Railway"],       gh:"https://github.com/yourusername/stock-prediction",      demo:"https://portfolio-nine-theta-pa3j8pt4aa.vercel.app/", color:C.blue,   emoji:"📈" },
